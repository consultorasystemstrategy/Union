 ...
 */
public class DbAdapter_Motivo_Devolucion {

    public static final String motivo_id = "_id";
    public static final String motivo_DevolucionId = "MotdIMotivoDevolucionId";
    public static final String motivo_Descripcion = "MotdIMotivoDevolucionId";
    ...
    public DbAdapter_Motivo_Devolucion(Context ctx) {
        this.mCtx = ctx;
    }

    public DbAdapter_Motivo_Devolucion open() throws SQLException {
