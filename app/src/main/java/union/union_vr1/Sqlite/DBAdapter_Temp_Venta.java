...
public class DBAdapter_Temp_Venta {
    ...
    public long createTempVentaDetalle(
            ...
            double precio_unit, String prom_anterior, String devuelto){
    ...
    public boolean deleteTempVentaDetalleById(String id) {

        int doneDelete = 0;
        doneDelete = mDb.delete(SQLITE_TABLE_Temp_Venta_Detalle, temp_venta_detalle+"=?", new String[]{id});
        Log.w(TAG, Integer.toString(doneDelete));
        return doneDelete > 0;
