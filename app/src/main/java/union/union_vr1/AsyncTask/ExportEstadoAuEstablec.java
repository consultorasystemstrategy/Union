        ...
        try {
            ...
            if (existe == 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    NuevoEstablecimiento nuevoEstablecimiento = new NuevoEstablecimiento(cursor.getString(cursor.getColumnIndexOrThrow(DbAdapter_Establecimeinto_Historial.establec_nro_documento)), Utils.getDatePhone(), Constants.REGISTRO_INTERNET, idAgente, Constants._OBSERVACION);
